            ...
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-6">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                />
                <button
                  onClick={handleTrack}
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                key={idx}
                className="group p-8 rounded-2xl bg-white border-2 border-gray-100 hover:border-primary transition-all duration-300 hover:shadow-xl"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
      ...
      <section id="pricing" className="py-20 px-4 sm:px-6 bg-gray-50">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {[
              { value: 'R$ 50', label: 'Início', desc: 'Comece seu negócio', bonus: '', popular: false },
              { value: 'R$ 100', label: 'Médio', desc: 'Escale seus envios', bonus: '+5% bônus', popular: true },
              { value: 'R$ 200', label: 'Pro', desc: 'Volume profissional', bonus: '+10% bônus', popular: false },
            ].map((item, idx) => (
              <motion.div
                key={idx}
                className={`relative p-8 rounded-2xl text-center transition-all ${
                  item.popular
                    ? 'bg-[#121212] text-white shadow-2xl scale-105 border-2 border-primary'
              ...
              >
                ...
                {item.bonus && (
                  <div className="text-sm font-medium text-primary mb-4">{item.bonus}</div>
                )}
            ...
            >
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  'Transportadoras parceiras (Rodonaves e mais)',
                  'Rastreamento em tempo real',
                  'Coleta agendada no Brás-SP',
                ].map((item, idx) => (
              ...
              <button
                onClick={() => navigate('/cadastro-cliente')}
                className="inline-flex items-center gap-3 px-7 py-3.5 bg-primary hover:bg-primary/90 rounded-xl font-semibold text-primary-foreground transition-all shadow-lg shadow-primary/30"
              >
                Começar agora
            ...
            >
              <div className="flex items-center justify-center min-h-[320px]">
                ...
                <div className="relative w-full max-w-md">
                  ...
                  <div className="absolute top-[50%] left-[35%] w-2 h-2 bg-primary rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
                  <div className="absolute top-[55%] left-[28%] w-2.5 h-2.5 bg-primary rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
                  <div className="absolute top-[48%] left-[32%] w-2 h-2 bg-primary/60 rounded-full animate-pulse" style={{ animationDelay: '1.5s' }} />
                </div>
              </div>
            </motion.div>
          </div>
