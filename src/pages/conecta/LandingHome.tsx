  ...
  return <div className="min-h-screen bg-white text-foreground overflow-hidden font-body">
      ...
      <section className="relative pt-[60px]">
        <div className="relative h-[480px] sm:h-[540px] lg:h-[580px] overflow-hidden">
          <video ref={videoRef} src="/videos/hero-video.mp4" autoPlay loop playsInline onTimeUpdate={handleTimeUpdate} className="w-full h-full object-cover object-[center_25%]" />
