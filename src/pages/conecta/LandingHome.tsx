...
export const LandingHome = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-hidden" style={{ fontFamily: "'Inter', 'Poppins', sans-serif" }}>
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100">
        <div className="container mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          {/* Logo */}
          <img src={logoBrhub} alt="BRHUB ENVIOS" className="h-[168px] w-auto" />
      ...
      <footer className="py-10 px-4 sm:px-6 border-t border-gray-100 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <img src={logoBrhub} alt="BRHUB ENVIOS" className="h-[120px] w-auto" />
