...
function brhub_shipping_calculator() {
  ...
  const configOptions = [
    { nome: 'apiKey', tipo: 'string', obrigatorio: true, descricao: 'Sua chave de API do BRHUB Envios' },
    { nome: 'email', tipo: 'string', obrigatorio: true, descricao: 'Email de login do cliente BRHUB' },
    { nome: 'senha', tipo: 'string', obrigatorio: true, descricao: 'Senha do cliente BRHUB' },
