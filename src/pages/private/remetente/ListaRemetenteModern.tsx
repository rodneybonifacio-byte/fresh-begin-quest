...
import { User, Plus, MapPin, Mail, Phone, Pencil } from "lucide-react";
...
import { ModalEditarRemetente } from "./ModalEditarRemetente";
...
export const ListaRemetenteModern = () => {
  ...
  const handleEditRemetente = (remetente: IRemetente) => {
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors shadow-lg hover:shadow-xl text-slate-50"
            >
              <Plus size={20} />
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => handleEditRemetente(remetente)}
