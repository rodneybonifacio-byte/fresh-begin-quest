                ...
                <form onSubmit={handleSubmit(handlerOnSubmit)} className="space-y-6">
                    ...
                    <div className="bg-card border border-border rounded-lg p-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <select
                                    {...register('embalagem.formatoObjeto')}
                                    ...
                                    onChange={(e) => {
                                        setValue('embalagem.formatoObjeto', e.target.value);
                                    }}
                                >
                                    <option value="CAIXA_PACOTE">Caixa / Pacote</option>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="flex items-end">
                                <button
                                    ...
                                    disabled={!selectedEmbalagem || !destinatarioSelecionado}
                    ...
                    <div className="flex gap-4 justify-end pt-6">
                        <button
                            ...
                            className="px-6 py-3 border border-border rounded-lg text-foreground font-medium hover:bg-accent transition-colors flex items-center gap-2"
                        >
                            <X className="w-5 h-5" />
                            Cancelar
                        </button>
