...
const items: TabItemType[] = [
    ...
    { value: "SAIU_PARA_ENTREGA", label: "Saiu p/ Entrega", icon: Truck, color: "teal" },
...
const colorClasses: Record<string, { bg: string; text: string; activeBg: string; activeText: string; ring: string }> = {
    ...
    teal: { bg: "bg-teal-50 dark:bg-teal-900/20", text: "text-teal-600 dark:text-teal-400", activeBg: "bg-teal-600", activeText: "text-white", ring: "ring-teal-600/20" },
